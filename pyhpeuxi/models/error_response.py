...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    debug_id: StrictStr = Field(alias="debugId")
    error_code: StrictStr = Field(alias="errorCode")
    http_status_code: StrictInt = Field(alias="httpStatusCode")
    message: StrictStr
    error_details: Optional[List[ErrorDetail]] = Field(default=None, alias="errorDetails")
    __properties: ClassVar[List[str]] = ["debugId", "errorCode", "httpStatusCode", "message", "errorDetails"]
