...
class NetworkGroupAssignmentPostRequest(BaseModel):
    """
    NetworkGroupAssignmentPostRequest
    """ # noqa: E501
    group_id: StrictStr = Field(description="The unique identifier of the group", alias="groupId")
    network_id: StrictStr = Field(description="The unique identifier of the network", alias="networkId")
    __properties: ClassVar[List[str]] = ["groupId", "networkId"]
